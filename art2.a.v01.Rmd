...
a.data <- read_delim("~/R/r-projects/00.arts/data.art2vallejo/datos.art2.agencias.csv","\t", escape_double = FALSE, locale = locale(decimal_mark = ",", grouping_mark = ""), trim_ws = TRUE)
options(width=9999)
```
...
```{r}
#suppressMessages(agencias <- read_spss("~/R/r-data/00.pls-seminr/art2-vallejo/agencias_dc.sav"))
#wb = createWorkbook()

...
a.df <- a.data[,c(1:3,4:7,8:9,11,14:15,18:19,20:21,23,24:26)]
glimpse(a.df)
#======================================
# Create mesaurment model
#======================================
a.simple_mm <- constructs(
  composite("ICT", multi_items("ICT", c(1:3))),
  composite("VCC", multi_items("VCC", c(1:2, 4))),
  composite("TRUST", multi_items("TRUST", c(1:3))),
  composite("COMMITMENT", multi_items("COMMITMENT", c(1:4))),
  composite("SOCSAT", multi_items("SOCSAT", c(2:3))),
  composite("ECOSAT", multi_items("ECOSAT", c(1:2))),
...
Para el modelo de medida se han considerado constructos composite, modo A. De este modo, el primer paso debe ser observar el resumen de los indicadores de fiabilidad, consistencia interna y validez.
...
prediction_relevance <- q2(cov(a.df), predictions.blindfold, model=modelo.lavaan)
...
pwr.f2.test(u =4, v = 251 , f2 =0.15 , sig.level = 0.05, power = NULL)

#Si quisiéramos saber la muestra necesaria para alcanzar una potencia del 80%

pwr.f2.test(u =4, v = NULL , f2 =0.15 , sig.level = 0.05, power = 0.80)
```

...
simple_model <- estimate_pls(data = a.df,
                                      ...
                                      missing_value = NA)
```
Un análisis descrptivo de los indicadores arroja los siguientes resultados.
...
library(semPLS)
library(readr)
#datos <- read_delim("~/R/r-data/00.pls-seminr/datos.csv", ";", escape_double = FALSE,trim_ws = TRUE)
...
#En nuestro ejemplo tenemos 256 y la regresión más complicada es la del constructo VcC
#con 5 regresores por lo que v=256-5-1=250. Se deja como NULL lo que se quiere calcular

library(pwr)
pwr.f2.test(u =5, v = 250 , f2 =0.15 , sig.level = 0.05, power = NULL)

...
a.simple_mm <- constructs(
     composite("ICT", multi_items("ICT", 1:5), weights = mode_B ),
     composite("VCC", multi_items("VCC", c(1:6)), weights = mode_B),
     composite("TRUST", multi_items("TRUST", 1:3), weights = mode_B),
     composite("COMMITMENT", multi_items("COMMITMENT", 1:4), weights = mode_B),
     composite("SOCSAT", multi_items("SOCSAT",1:3), weights = mode_B),
     composite("ECOSAT", multi_items("ECOSAT", 1:3), weights = mode_B),
     composite("LOY", multi_items("LOY",c(1:2,4)), weights = mode_B))
#======================================

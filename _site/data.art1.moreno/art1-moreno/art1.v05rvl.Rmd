...
NOTA: El siguiente documento contiene el modelo abajo descrito que utiliza un constructo de segundo orden que se genera con los ítems de sostenibilidad. Aqui ya viene el resultado para poder hacer la predicción.

Quedar por ajustar. La predicción final no está funcional (comunicado error a Soumya y a Nicholas), pero se puede hacer sin probelma utilizando los _latent variables scores_ que se producen en el propio modelo. Solo hay que estimar y predecir.
...
Este modelo sirve para la predicción con las latentes calculadas en el anterior. 
...
#======================================
sm <- relationships(
     paths(from = c("ICT"), to = c("RVL")),
     paths(from = c("SUS"), to = c("RVL")),
